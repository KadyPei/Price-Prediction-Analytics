...
public class MinMaxDiff {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
	    if (args.length != 2) {
	        System.err.println("Usage: minmaxMR <input path> <output path>");
	        System.exit(-1);
	    }
		 // Configuration
       ...
       job.setJobName("minmaxdiff job1");
       ...
       job.setMapperClass(MinMaxDiff_Mapper.class);
       job.setReducerClass(MinMaxDiff_Reducer.class);
       /* ------------------------------------------------------------------------*/
