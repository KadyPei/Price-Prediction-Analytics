...
public class CountPerZipcode {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
	    if (args.length != 2) {
	        System.err.println("Usage: maeda_mr1 <input path> <output path>");
	        System.exit(-1);
	    }
		 // Configuration
       ...
       //Job job = new Job();
       job.setJarByClass(CountPerZipcode.class);
       job.setJobName("CountPerZipcode job1");
       ...
       job.setMapperClass(CountPerZipcode_Mapper.class);
       job.setReducerClass(CountPerZipcode_Reducer.class);
       /* ------------------------------------------------------------------------*/
